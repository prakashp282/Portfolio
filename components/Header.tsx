...
import { navLinks } from "contents/nav-items";
    ...
    <header className="md:flex">
      ...
      >
        <div className="w-full h-full mx-auto max-w-6xl flex items-center justify-between">
          <Link
            href="/"
            className="text-xl sm:text-2xl md:hover:text-lightaccent dark:md:hover:text-darkaccent focus-visible:outline-lightaccent dark:focus-visible:outline-darkaccent"
          >
            Prakash
            <span className="text-lightaccent dark:text-darkaccent">Patel</span>
          </Link>
          <nav className="flex items-center">
              ...
              <ul className="flex justify-evenly items-center py-1">
                {navLinks.map((navLink) => (
                  <li key={navLink.url}>
                    <a
                      href={navLink.url}
                      className={`text-sm md:text-lg flex flex-row items-center w-[4.5rem] md:w-auto dark:fill-textlight md:mr-6 md:hover:text-lightaccent md:dark:hover:text-darkaccent link-outline ${
                        currentSection === navLink.text.toLocaleLowerCase() &&
                        "text-lightaccent dark:text-darkaccent fill-lightaccent dark:fill-darkaccent "
                      }`}
                    >
            ...
            >
              <svg
                ...
                width="24"
                height="24"
                className="fill-textlight hidden dark:inline-block transform scale-110 md:dark:hover:fill-darkaccent"
              >
              ...
              <svg
                ...
                width="24"
                height="24"
                className="dark:hidden transform scale-90 md:hover:fill-lightaccent "
              >
