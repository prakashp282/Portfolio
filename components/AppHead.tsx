...
const AppHead: React.FC<Props> = ({
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/PrakashPatel-blog-og.png`;
  let appOgImageAlt = "Prakash Patel's Blog";
