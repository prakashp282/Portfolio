      ...
      <div className={`project-card project-card-${index}`}>
        ...
        <div className="overflow-hidden">
          <div className="project-text flex items-center justify-between">
            <h3 className=" text-lightaccent dark:text-darkaccent text-lg my-1 font-medium">
              {project.title}
            </h3>
            <div className="flex items-center space-x-5 sm:space-x-3 my-2 sm:my-0 mr-[0.1rem]">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="focus-visible:outline-lightaccent dark:focus-visible:outline-darkaccent mr-1 rounded-full"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="focus-visible:outline-lightaccent dark:focus-visible:outline-darkaccent mr-8 rounded-full"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
