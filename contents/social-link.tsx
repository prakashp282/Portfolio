...
export const socialLinks = [
  links.github && {
    id: 1,
    title: "Prakash Patel's Github Profile",
    link: links.github,
    svg: (
      <svg
        ...
        width="24"
        height="24"
        className="dark:fill-bglight hover:fill-lightaccent dark:hover:fill-darkaccent"
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
  ...
  links.linkedin && {
    id: 2,
    title: "Prakash Patel's LinkedIn Profile",
    link: links.linkedin,
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  links.dev && {
    id: 3,
    title: "Check Prakash Patel on Dev.to",
    link: links.dev,
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  links.facebook && {
    id: 4,
    title: "Prakash Patel's Profile on Facebook",
    link: links.facebook,
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
